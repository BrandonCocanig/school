...
#todo set if one win is = 4 then end game otherwise

#todo swap number rps for letters rp
...
#game will keep repeating until  turn 7 is over (fix to best of 7 not to 7)
while TurnCounter < 8:
    print ("*" * 50)
...
# check to see if cwins or hwins = 4 or more, if true while loop will break
    if CWins > 3:
        break
    if HWins > 3:
        break
